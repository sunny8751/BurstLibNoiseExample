...
namespace NodeEditorFramework 
{
	...
	public static partial class NodeEditorGUI 
	{
		...
		public static void EndNodeGUI () 
		{
			...
			//UnityEditor.EditorStyles.label.normal.textColor = UnityEditor.EditorStyles.largeLabel.normal.textColor;
			//UnityEditor.EditorStyles.label.hover.textColor = UnityEditor.EditorStyles.largeLabel.hover.textColor;
//			UnityEditor.EditorStyles.label.active.textColor = UnityEditor.EditorStyles.largeLabel.active.textColor;
			//UnityEditor.EditorStyles.label.focused.textColor = UnityEditor.EditorStyles.largeLabel.focused.textColor;
			#endif
		}
